...
Dispatch the `engineer-senior` subagent via the Agent tool with the user's task description as the prompt. It sets up its own worktree and context (standalone-invocation section) and **defers teardown** — worktree stays up through merge.
